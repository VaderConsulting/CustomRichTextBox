...
Public Class CustomRichTextBox : Inherits RichTextBox
    ...
    Private Sub CustomRichTextBoxl_DragEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles MyBase.DragEnter
    ...
    Private Sub CustomRichTextBox_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles MyBase.DragDrop
        Dim i As Int16
        Dim s As String

        ' Get start position to drop the text.
        i = MyBase.SelectionStart
        s = MyBase.Text.Substring(i)
        MyBase.Text = MyBase.Text.Substring(0, i)

        ' Drop the text on to the RichTextBox.
        MyBase.Text = MyBase.Text & e.Data.GetData(DataFormats.Text).ToString()
        MyBase.Text = MyBase.Text & s
    End Sub
